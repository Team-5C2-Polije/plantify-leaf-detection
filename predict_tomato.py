...
def predict_image(image_path, model_path="random_forest_tomato_model.pkl"):
    ...
    print(f"Hasil prediksi untuk gambar {image_path}: {'Sehat' if prediction[0] == 0 else 'Sakit'}")

if __name__ == "__main__":
    # Path gambar daun tomat yang akan diuji
    image_path = r"C:\dev\python\tomato-leaf-sistem\dataset\train\sehat\tomato-test-sehat-07.jpg"  # Ganti dengan path gambar Anda
    model_path = "random_forest_tomato_model.pkl"  # Path ke model
